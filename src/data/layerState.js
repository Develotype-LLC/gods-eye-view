...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({id: 'ground-motion', token: 'v', disposition: 'enabled-only'}),
  Object.freeze({id: 'injection-wells', token: 'k', disposition: 'enabled-only'}),
  Object.freeze({id: 'land-parcels', token: '1', disposition: 'enabled-only'}),
  ...
  Object.freeze({id: 'reference-records', token: 'y', disposition: 'enabled-only'}),
  Object.freeze({
    id: 'rocket-launches',
    token: 'x',
    disposition: 'enabled-only',
  ...
  Object.freeze({id: 'terrain-difference', token: '0', disposition: 'enabled-only'}),
  ...
  Object.freeze({ id: 'us-basins', token: 'o', disposition: 'enabled-only' }),
]);
